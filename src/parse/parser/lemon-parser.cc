...
static const char *const yyTokenName[] = { 
  "$",             "PLUS",          "MINUS",         "MUL",         
  "DIV",           "ASSIGN",        "PLUSASSIGN",    "MINUSASSIGN", 
  "MULASSIGN",     "DIVASSIGN",     "GREATER",       "GREATEROREQUAL",
  "LESSER",        "LESSEROREQUAL",  "EQUAL",         "NOTEQUAL",    
  "NOT",           "INV",           "INCREMENTATION",  "DECREMENTATION",
  "LPAREN",        "RPAREN",        "LBRACKET",      "RBRACKET",    
  "LBRACE",        "RBRACE",        "SEMICOLON",     "COLON",       
  "COMMA",         "IDENT",         "NUMBER",        "FLOAT",       
  "STRING",        "COMMENT",       "QUESTIONMARK",  "DOT",         
  ...
  "EQUATION",      "EXPANDABLE",    "EXPONENT",      "EXTENDS",     
  "EXTERNAL",      "FALSE",         "FINAL",         "FLOW",        
  "FOR",           "FUNCTION",      "IF",            "IMPORT",      
  "IMPURE",        "IN",            "INITIAL",       "INNER",       
  "INPUT",         "LOOP",          "MODEL",         "NEGATE",      
  "OPERATOR",      "OR",            "OUTER",         "OUTPUT",      
  "PACKAGE",       "PARAMETER",     "PARTIAL",       "PROTECTED",   
