...
static const YYACTIONTYPE yy_default[] = {
 ...
 /*   370 */   492,  491,  490,  731,  637,  732,  591,  596,  581,  590,
...
static const char *const yyRuleName[] = {
 ...
 /* 246 */ "string_concatenation ::= STRING",
 /* 247 */ "string_concatenation ::= string_concatenation PLUS STRING",
 /* 248 */ "opt_annotation ::=",
...
static void yy_reduce(
  ...
  */
      ...
      /* (1) stored_definition ::= */ yytestcase(yyruleno==1);
      /* (2) stored_definition ::= WITHIN opt_name SEMICOLON */ yytestcase(yyruleno==2);
      /* (3) stored_definition ::= stored_definition opt_final class_definition SEMICOLON */ yytestcase(yyruleno==3);
      /* (4) class_definition ::= opt_encapsulated class_prefixes class_specifier */ yytestcase(yyruleno==4);
      /* (5) class_prefixes ::= opt_partial kind */ yytestcase(yyruleno==5);
      /* (6) kind ::= CLASS */ yytestcase(yyruleno==6);
      /* (7) kind ::= MODEL */ yytestcase(yyruleno==7);
      /* (8) kind ::= opt_operator RECORD */ yytestcase(yyruleno==8);
      /* (9) kind ::= BLOCK */ yytestcase(yyruleno==9);
      /* (10) kind ::= opt_expandable CONNECTOR */ yytestcase(yyruleno==10);
      /* (11) kind ::= TYPE */ yytestcase(yyruleno==11);
      /* (12) kind ::= PACKAGE */ yytestcase(yyruleno==12);
      /* (13) kind ::= opt_purity FUNCTION */ yytestcase(yyruleno==13);
      /* (14) kind ::= opt_purity OPERATOR_FUNCTION */ yytestcase(yyruleno==14);
      /* (15) kind ::= OPERATOR */ yytestcase(yyruleno==15);
      /* (16) opt_purity ::= */ yytestcase(yyruleno==16);
      /* (17) opt_purity ::= PURE */ yytestcase(yyruleno==17);
      /* (18) opt_purity ::= IMPURE */ yytestcase(yyruleno==18);
      /* (19) class_specifier ::= IDENT string_comment composition end_ident */ yytestcase(yyruleno==19);
      /* (20) class_specifier ::= short_class_specifier */ yytestcase(yyruleno==20);
      /* (21) class_specifier ::= IDENT EQUAL DER OPAREN name COMMA ident_list CPAREN comment */ yytestcase(yyruleno==21);
      /* (22) class_specifier ::= EXTENDS IDENT opt_class_modification string_comment composition end_ident */ yytestcase(yyruleno==22);
      /* (23) short_class_specifier ::= IDENT EQUAL base_prefix name opt_array_subscripts opt_class_modification comment */ yytestcase(yyruleno==23);
      /* (24) short_class_specifier ::= IDENT EQUAL ENUMERATION OPAREN opt_enum_list_or_colon CPAREN comment */ yytestcase(yyruleno==24);
      /* (25) ident_list ::= IDENT */ yytestcase(yyruleno==25);
      /* (26) ident_list ::= ident_list COMMA IDENT */ yytestcase(yyruleno==26);
      /* (27) end_ident ::= END_IDENT */ yytestcase(yyruleno==27);
      /* (28) base_prefix ::= type_prefix */ yytestcase(yyruleno==28);
      /* (29) opt_enum_list_or_colon ::= opt_enum_list */ yytestcase(yyruleno==29);
      /* (30) opt_enum_list_or_colon ::= COLON */ yytestcase(yyruleno==30);
      /* (31) opt_enum_list ::= */ yytestcase(yyruleno==31);
      /* (32) opt_enum_list ::= enum_list */ yytestcase(yyruleno==32);
      /* (33) enum_list ::= enumeration_literal */ yytestcase(yyruleno==33);
      /* (34) enum_list ::= enum_list COMMA enumeration_literal */ yytestcase(yyruleno==34);
      /* (35) enumeration_literal ::= IDENT comment */ yytestcase(yyruleno==35);
      /* (36) composition ::= element_list section_list opt_external opt_annotation_semicolon */ yytestcase(yyruleno==36);
      /* (37) element_list ::= */ yytestcase(yyruleno==37);
      /* (38) element_list ::= element_list element SEMICOLON */ yytestcase(yyruleno==38);
      /* (39) element ::= import_clause */ yytestcase(yyruleno==39);
      /* (40) element ::= extends_clause */ yytestcase(yyruleno==40);
      /* (41) element ::= element_decorations class_definition_or_component_clause */ yytestcase(yyruleno==41);
      /* (42) element ::= element_decorations REPLACEABLE class_definition_or_component_clause opt_constraining_clause_comment */ yytestcase(yyruleno==42);
      /* (43) element_decorations ::= opt_redeclare opt_final opt_inner opt_outer */ yytestcase(yyruleno==43);
      /* (44) class_definition_or_component_clause ::= class_definition */ yytestcase(yyruleno==44);
      /* (45) class_definition_or_component_clause ::= component_clause */ yytestcase(yyruleno==45);
      /* (46) opt_constraining_clause_comment ::= */ yytestcase(yyruleno==46);
      /* (47) opt_constraining_clause_comment ::= constraining_clause comment */ yytestcase(yyruleno==47);
      /* (48) import_clause ::= IMPORT IDENT EQUAL name comment */ yytestcase(yyruleno==48);
      /* (49) import_clause ::= IMPORT name opt_import_filter comment */ yytestcase(yyruleno==49);
      /* (50) opt_import_filter ::= */ yytestcase(yyruleno==50);
      /* (51) opt_import_filter ::= DOT_STAR */ yytestcase(yyruleno==51);
      /* (52) opt_import_filter ::= DOT STAR */ yytestcase(yyruleno==52);
      /* (53) opt_import_filter ::= DOT OBRACE import_list CBRACE */ yytestcase(yyruleno==53);
      /* (54) import_list ::= IDENT */ yytestcase(yyruleno==54);
      /* (55) import_list ::= IDENT COMMA import_list */ yytestcase(yyruleno==55);
      /* (56) section_list ::= */ yytestcase(yyruleno==56);
      /* (57) section_list ::= section_list section */ yytestcase(yyruleno==57);
      /* (58) section ::= PUBLIC element_list */ yytestcase(yyruleno==58);
      /* (59) section ::= PROTECTED element_list */ yytestcase(yyruleno==59);
      /* (60) section ::= algorithm_section */ yytestcase(yyruleno==60);
      /* (61) section ::= equation_section */ yytestcase(yyruleno==61);
      /* (62) opt_external ::= */ yytestcase(yyruleno==62);
      /* (63) opt_external ::= EXTERNAL opt_language_specification opt_external_function_call opt_annotation SEMICOLON */ yytestcase(yyruleno==63);
      /* (64) opt_language_specification ::= */ yytestcase(yyruleno==64);
      /* (65) opt_language_specification ::= STRING */ yytestcase(yyruleno==65);
      /* (66) opt_external_function_call ::= */ yytestcase(yyruleno==66);
      /* (67) opt_external_function_call ::= IDENT OPAREN opt_expression_list CPAREN */ yytestcase(yyruleno==67);
      /* (68) opt_external_function_call ::= component_reference EQUAL IDENT OPAREN opt_expression_list CPAREN */ yytestcase(yyruleno==68);
      /* (69) extends_clause ::= EXTENDS name opt_class_modification opt_annotation */ yytestcase(yyruleno==69);
      /* (70) opt_constraining_clause ::= */ yytestcase(yyruleno==70);
      /* (71) opt_constraining_clause ::= constraining_clause */ yytestcase(yyruleno==71);
      /* (72) constraining_clause ::= CONSTRAINEDBY name opt_class_modification */ yytestcase(yyruleno==72);
      /* (73) component_clause ::= type_prefix type_specifier opt_array_subscripts component_list */ yytestcase(yyruleno==73);
      /* (74) type_prefix ::= flow_prefix variability_prefix causality_prefix */ yytestcase(yyruleno==74);
      /* (75) flow_prefix ::= */ yytestcase(yyruleno==75);
      /* (76) flow_prefix ::= FLOW */ yytestcase(yyruleno==76);
      /* (77) flow_prefix ::= STREAM */ yytestcase(yyruleno==77);
      /* (78) variability_prefix ::= */ yytestcase(yyruleno==78);
      /* (79) variability_prefix ::= DISCRETE */ yytestcase(yyruleno==79);
      /* (80) variability_prefix ::= PARAMETER */ yytestcase(yyruleno==80);
      /* (81) variability_prefix ::= CONSTANT */ yytestcase(yyruleno==81);
      /* (82) causality_prefix ::= */ yytestcase(yyruleno==82);
      /* (83) causality_prefix ::= INPUT */ yytestcase(yyruleno==83);
      /* (84) causality_prefix ::= OUTPUT */ yytestcase(yyruleno==84);
      /* (85) type_specifier ::= name */ yytestcase(yyruleno==85);
      /* (86) component_list ::= component_declaration */ yytestcase(yyruleno==86);
      /* (87) component_list ::= component_list COMMA component_declaration */ yytestcase(yyruleno==87);
      /* (88) component_declaration ::= declaration opt_condition_attribute comment */ yytestcase(yyruleno==88);
      /* (89) declaration ::= IDENT opt_array_subscripts opt_modification */ yytestcase(yyruleno==89);
      /* (90) opt_condition_attribute ::= */ yytestcase(yyruleno==90);
      /* (91) opt_condition_attribute ::= IF expression */ yytestcase(yyruleno==91);
      /* (92) opt_modification ::= */ yytestcase(yyruleno==92);
      /* (93) opt_modification ::= modification */ yytestcase(yyruleno==93);
      /* (94) modification ::= class_modification opt_eq_expression */ yytestcase(yyruleno==94);
      /* (95) modification ::= EQUAL expression */ yytestcase(yyruleno==95);
      /* (96) modification ::= ASSIGN_OP expression */ yytestcase(yyruleno==96);
      /* (97) opt_eq_expression ::= */ yytestcase(yyruleno==97);
      /* (98) opt_eq_expression ::= EQUAL expression */ yytestcase(yyruleno==98);
      /* (99) opt_class_modification ::= */ yytestcase(yyruleno==99);
      /* (100) opt_class_modification ::= class_modification */ yytestcase(yyruleno==100);
      /* (101) class_modification ::= OPAREN opt_argument_list CPAREN */ yytestcase(yyruleno==101);
      /* (102) opt_argument_list ::= */ yytestcase(yyruleno==102);
      /* (103) opt_argument_list ::= argument_list */ yytestcase(yyruleno==103);
      /* (104) argument_list ::= argument */ yytestcase(yyruleno==104);
      /* (105) argument_list ::= argument_list COMMA argument */ yytestcase(yyruleno==105);
      /* (106) argument ::= element_modification_or_replacable */ yytestcase(yyruleno==106);
      /* (107) argument ::= element_redeclaration */ yytestcase(yyruleno==107);
      /* (108) element_modification_or_replacable ::= opt_each opt_final element_modification_or_replacable_definition */ yytestcase(yyruleno==108);
      /* (109) element_modification_or_replacable_definition ::= element_modification */ yytestcase(yyruleno==109);
      /* (110) element_modification_or_replacable_definition ::= element_replacable */ yytestcase(yyruleno==110);
      /* (111) element_modification ::= name opt_modification string_comment */ yytestcase(yyruleno==111);
      /* (112) element_redeclaration ::= REDECLARE opt_each opt_final element_redeclaration_definition */ yytestcase(yyruleno==112);
      /* (113) element_redeclaration_definition ::= short_class_definition */ yytestcase(yyruleno==113);
      /* (114) element_redeclaration_definition ::= component_clause1 */ yytestcase(yyruleno==114);
      /* (115) element_redeclaration_definition ::= element_replacable */ yytestcase(yyruleno==115);
      /* (116) element_replacable ::= REPLACEABLE short_class_definition opt_constraining_clause */ yytestcase(yyruleno==116);
      /* (117) element_replacable ::= REPLACEABLE component_clause1 opt_constraining_clause */ yytestcase(yyruleno==117);
      /* (118) component_clause1 ::= type_prefix type_specifier component_declaration1 */ yytestcase(yyruleno==118);
      /* (119) component_declaration1 ::= declaration comment */ yytestcase(yyruleno==119);
      /* (120) short_class_definition ::= class_prefixes short_class_specifier */ yytestcase(yyruleno==120);
      /* (121) equation_section ::= INITIAL_EQUATION equation_list */ yytestcase(yyruleno==121);
      /* (122) equation_section ::= EQUATION equation_list */ yytestcase(yyruleno==122);
      /* (123) equation_list ::= */ yytestcase(yyruleno==123);
      /* (124) equation_list ::= equation_list equation SEMICOLON */ yytestcase(yyruleno==124);
      /* (125) algorithm_section ::= INITIAL_ALGORITHM statement_list */ yytestcase(yyruleno==125);
      /* (126) algorithm_section ::= ALGORITHM statement_list */ yytestcase(yyruleno==126);
      /* (127) statement_list ::= */ yytestcase(yyruleno==127);
      /* (128) statement_list ::= statement_list statement SEMICOLON */ yytestcase(yyruleno==128);
      /* (129) equation ::= simple_expression EQUAL expression comment */ yytestcase(yyruleno==129);
      /* (130) equation ::= if_equation comment */ yytestcase(yyruleno==130);
      /* (131) equation ::= for_equation comment */ yytestcase(yyruleno==131);
      /* (132) equation ::= connect_clause comment */ yytestcase(yyruleno==132);
      /* (133) equation ::= when_equation comment */ yytestcase(yyruleno==133);
      /* (134) equation ::= fname function_call_args comment */ yytestcase(yyruleno==134);
      /* (135) statement ::= component_reference ASSIGN_OP expression comment */ yytestcase(yyruleno==135);
      /* (136) statement ::= component_reference function_call_args comment */ yytestcase(yyruleno==136);
      /* (137) statement ::= OPAREN output_expression_list CPAREN ASSIGN_OP component_reference function_call_args comment */ yytestcase(yyruleno==137);
      /* (138) statement ::= BREAK comment */ yytestcase(yyruleno==138);
      /* (139) statement ::= RETURN comment */ yytestcase(yyruleno==139);
      /* (140) statement ::= if_statement comment */ yytestcase(yyruleno==140);
      /* (141) statement ::= for_statement comment */ yytestcase(yyruleno==141);
      /* (142) statement ::= while_statement comment */ yytestcase(yyruleno==142);
      /* (143) statement ::= when_statement comment */ yytestcase(yyruleno==143);
      /* (144) if_equation ::= IF expression THEN equation_list elseif_equation END_IF */ yytestcase(yyruleno==144);
      /* (145) elseif_equation ::= */ yytestcase(yyruleno==145);
      /* (146) elseif_equation ::= ELSEIF expression THEN equation_list elseif_equation */ yytestcase(yyruleno==146);
      /* (147) elseif_equation ::= ELSE equation_list */ yytestcase(yyruleno==147);
      /* (148) if_statement ::= IF expression THEN statement_list elseif_statement END_IF */ yytestcase(yyruleno==148);
      /* (149) elseif_statement ::= */ yytestcase(yyruleno==149);
      /* (150) elseif_statement ::= ELSEIF expression THEN statement_list elseif_statement */ yytestcase(yyruleno==150);
      /* (151) elseif_statement ::= ELSE statement_list */ yytestcase(yyruleno==151);
      /* (152) for_equation ::= FOR for_indices LOOP equation_list END_FOR */ yytestcase(yyruleno==152);
      /* (153) for_statement ::= FOR for_indices LOOP statement_list END_FOR */ yytestcase(yyruleno==153);
      /* (154) for_indices ::= for_index */ yytestcase(yyruleno==154);
      /* (155) for_indices ::= for_indices COMMA for_index */ yytestcase(yyruleno==155);
      /* (156) for_index ::= IDENT opt_in_expression */ yytestcase(yyruleno==156);
      /* (157) opt_in_expression ::= */ yytestcase(yyruleno==157);
      /* (158) opt_in_expression ::= IN expression */ yytestcase(yyruleno==158);
      /* (159) while_statement ::= WHILE expression LOOP statement_list END_WHILE */ yytestcase(yyruleno==159);
      /* (160) when_equation ::= WHEN expression THEN equation_list elsewhen_equation END_WHEN */ yytestcase(yyruleno==160);
      /* (161) elsewhen_equation ::= */ yytestcase(yyruleno==161);
      /* (162) elsewhen_equation ::= ELSEWHEN expression THEN equation_list elsewhen_equation */ yytestcase(yyruleno==162);
      /* (163) elsewhen_equation ::= ELSE equation_list */ yytestcase(yyruleno==163);
      /* (164) when_statement ::= WHEN expression THEN statement_list elsewhen_statement END_WHEN */ yytestcase(yyruleno==164);
      /* (165) elsewhen_statement ::= */ yytestcase(yyruleno==165);
      /* (166) elsewhen_statement ::= ELSEWHEN expression THEN statement_list elsewhen_statement */ yytestcase(yyruleno==166);
      /* (167) elsewhen_statement ::= ELSE statement_list */ yytestcase(yyruleno==167);
      /* (168) connect_clause ::= CONNECT OPAREN component_reference COMMA component_reference CPAREN */ yytestcase(yyruleno==168);
      /* (169) expression ::= simple_expression */ yytestcase(yyruleno==169);
      /* (170) expression ::= if_expression */ yytestcase(yyruleno==170);
      /* (171) if_expression ::= IF expression THEN expression elseif_else_expression */ yytestcase(yyruleno==171);
      /* (172) elseif_else_expression ::= ELSEIF expression THEN expression elseif_else_expression */ yytestcase(yyruleno==172);
      /* (173) elseif_else_expression ::= ELSE expression */ yytestcase(yyruleno==173);
      /* (174) simple_expression ::= basic_expression */ yytestcase(yyruleno==174);
      /* (175) simple_expression ::= basic_expression COLON basic_expression */ yytestcase(yyruleno==175);
      /* (176) simple_expression ::= basic_expression COLON basic_expression COLON basic_expression */ yytestcase(yyruleno==176);
      /* (177) basic_expression ::= primary */ yytestcase(yyruleno==177);
      /* (178) basic_expression ::= basic_expression OR basic_expression */ yytestcase(yyruleno==178);
      /* (179) basic_expression ::= basic_expression AND basic_expression */ yytestcase(yyruleno==179);
      /* (180) basic_expression ::= NOT basic_expression */ yytestcase(yyruleno==180);
      /* (181) basic_expression ::= basic_expression REL_OP basic_expression */ yytestcase(yyruleno==181);
      /* (182) basic_expression ::= basic_expression ADD_OP_PARTIAL basic_expression */ yytestcase(yyruleno==182);
      /* (183) basic_expression ::= basic_expression PLUS basic_expression */ yytestcase(yyruleno==183);
      /* (184) basic_expression ::= ADD_OP_PARTIAL basic_expression */ yytestcase(yyruleno==184);
      /* (185) basic_expression ::= PLUS basic_expression */ yytestcase(yyruleno==185);
      /* (186) basic_expression ::= basic_expression MUL_OP_PARTIAL basic_expression */ yytestcase(yyruleno==186);
      /* (187) basic_expression ::= basic_expression DOT_STAR basic_expression */ yytestcase(yyruleno==187);
      /* (188) basic_expression ::= basic_expression EXP_OP basic_expression */ yytestcase(yyruleno==188);
      /* (189) primary ::= UNSIGNED_NUMBER */ yytestcase(yyruleno==189);
      /* (190) primary ::= STRING */ yytestcase(yyruleno==190);
      /* (191) primary ::= component_reference */ yytestcase(yyruleno==191);
      /* (192) primary ::= primary_boolean */ yytestcase(yyruleno==192);
      /* (193) primary ::= fname function_call_args */ yytestcase(yyruleno==193);
      /* (194) primary ::= primary_operator function_call_args */ yytestcase(yyruleno==194);
      /* (195) primary ::= OPAREN output_expression_list CPAREN */ yytestcase(yyruleno==195);
      /* (196) primary ::= OBRACKET expression_matrix CBRACKET */ yytestcase(yyruleno==196);
      /* (197) primary ::= OBRACE function_arguments CBRACE */ yytestcase(yyruleno==197);
      /* (198) primary ::= END */ yytestcase(yyruleno==198);
      /* (199) primary_boolean ::= TRUE */ yytestcase(yyruleno==199);
      /* (200) primary_boolean ::= FALSE */ yytestcase(yyruleno==200);
      ...
      /* (246) string_concatenation ::= STRING */ yytestcase(yyruleno==246);
      /* (247) string_concatenation ::= string_concatenation PLUS STRING */ yytestcase(yyruleno==247);
...
#line 20 "/Users/phryne/Desktop/mojito/src/parse/parser/lemon-parser.lm"
        ...
        parser->error(true);
#line 1954 "/Users/phryne/Desktop/mojito/src/parse/parser/lemon-parser.c"
  umodParseARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
...
#line 1976 "/Users/phryne/Desktop/mojito/src/parse/parser/lemon-parser.c"
  umodParseARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
